...
const Contact = () => {
  ...
  const handleContact = () => {
    ...
    window.open(
      "https://www.linkedin.com/in/diwash-dhungana-540a7a176/",
      "_blank",
      "noopener noreferrer"
    );
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with Diwas Dhungana, an Software Engineer I  and Full-Stack & Web3 Developer specializing in blockchain technologies and web development."
        />
      </Helmet>
